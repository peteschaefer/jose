...
/**	a Dynamic Array of float's
 * <p>
 * modelled after java.util.ArrayList but stores float's instead of Objects.
	...
	implements Cloneable
{
    ...
    */
	...
	public FloatArray(String[] array) {
		this(array.length);
		addAll(array);
	}
	...
	public FloatArray(int initialCapacity) {
		fArray = new float[initialCapacity];
		fSize = 0;
	}

	public FloatArray(String s, String delimiter)
	{
		this();
	 ...
	 */
	public void addAll(float[] elems) {
		if (elems!=null)
	 ...
	 */
	public void addAll(int index, float[] elems, int start, int length) {
		if (elems==null)
			return;
	 ...
	 * @param elems the elements to be added
	 */
	public void addAll(FloatArray elems) {
		if (elems!=null)
	 ...
	 */
	public Object clone() {
		FloatArray clone = new FloatArray(fArray.length);
	 ...
	 * Example: "(1,2,3,4)"
	 */
	public static String toString(FloatArray array) {
	...
	public static final String arrayToString(float[] a, String delimiter) {
	...
	public static final String arrayToString(float[] a, int from, int to, String delimiter) {
		StringBuffer buf = new StringBuffer();
		if (from<to)
			buf.append(Float.toString(a[from]));
	 ...
	 * Copies an array.
	 */
	public static final void arraycopy(String[] from, int from_idx, float[] to, int to_idx, int length)
	{
		while (length-- > 0)		
	...
	public float peek()				{ return (fSize==0) ? 0:fArray[fSize-1]; }
	public float pop()				{ return (fSize==0) ? 0:fArray[--fSize]; }
	...
	public class Iterator
	{
		...
		public final float next()		{ return get(fCurrent++); }
    ...
    public class ObjIterator implements java.util.Iterator
    {
        ...
        public final float nextFloat()	{ return get(fCurrent++); }
        public final void remove()		{ removeRange(fCurrent,fCurrent+1); }
    }
