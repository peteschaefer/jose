 ...
 *
 * -----------------------------------------------------------------------------------------------------------
 * null can be used as key and as value
 *
        	...
        	implements Map
{
	 ...
	 */
	public ObjHashMap(int capacity, float loadFactor)
	{
	...
	{
		if (map instanceof ObjHashMap) {
			//	performance shortcut for IntHashMaps
			ObjHashMap imap = (ObjHashMap)map;
	 ...
	 */
 	private final int putAll(Object[] keys, Object[] values)
	{
		int result = 0;
		for (int i=keys.length-1; i>=0; i--)
		{
			if (put(keys[i],values[i]) != null)
				result++;
		}
		return result;
	}
	...
	{
		return new ObjHashMapValueCollection();
	}
	 ...
	 */
 	private final int putAllInternal(Object[] keys, Object[] values)
	{
		int result = 0;
		for (int i=keys.length-1; i>=0; i--)
		{
	 ...
	 * */
	public class ValueIterator extends ObjMap.Iterator
	{
	 ...
	 * */
	public class EntryIterator extends ObjMap.Iterator
	{
	 ...
	 */
	public class ObjHashMapKeySet extends ObjMap.KeySet implements Set
	{
		/**
		 * @see IntHashMap#remove(java.lang.Object)
		 */
		public boolean remove(Object obj) {
			return ObjHashMap.this.remove(obj) != null;
		}
...
//			TODO return ObjHashMap.retainAllKeys(coll);
			throw new UnsupportedOperationException();
		}

		/**
		 * @see IntHashMap#removeAll(java.util.Collection)
		 */
		public boolean removeAll(Collection coll) {
			return ObjHashMap.this.removeAll(coll) > 0;
		}

		/**
		 * @see IntHashMap#keyIterator()
		 */
		public java.util.Iterator iterator()
		{
			return ObjHashMap.this.keyIterator();
		}
	}
	 ...
	 */
	public class ObjHashMapValueCollection extends ObjMap.AbstractSet implements Collection
	{
		/**
		 * @see IntHashMap#removeValue(java.lang.Object)
		 */
		public boolean remove(Object obj) {
			return ObjHashMap.this.removeValue(obj) > 0;
		}

		/**
		 * @see IntHashMap#removeAllValues(java.util.Collection)
		 */
		public boolean removeAll(Collection coll) {
			return ObjHashMap.this.removeAllValues(coll) > 0;
		}

		/**
		 * @see IntHashMap#retainAllValues(java.util.Collection)
		 */
		public boolean retainAll(Collection coll) {
			return ObjHashMap.this.retainAllValues(coll) > 0;
		}
		 ...
		 */
		public java.util.Iterator iterator() {
			return ObjHashMap.this.valueIterator();
		}
		...
		public Object[] toArray() {
			return ObjHashMap.this.valueArray(null);
		}
		...
		public Object[] toArray(Object[] array) {
			return ObjHashMap.this.valueArray(array);
		}
	}
	 ...
	 */
	public class ObjHashMapEntrySet extends ObjMap.AbstractSet implements Set
	{
		/**
		 * @see IntHashMap#entryIterator()
		 */
		public java.util.Iterator iterator()
		{
			return ObjHashMap.this.entryIterator();
		}
	}
