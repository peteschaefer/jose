...
/**
 * defines all MySQL error codes
 * as returned by SQLException.getErrorCode()
 */

public interface MySqlError
{
public static final int ER_ERROR_FIRST = 1000;
...
public static final int ER_ERROR_LAST = 1453;
