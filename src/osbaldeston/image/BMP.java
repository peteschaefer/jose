...
public class BMP {
	 ...
	 * Creates an BMP by reading from the given File.
	 *
	 * @param input Input Stream to read BMP from
	 */
	public BMP(InputStream input) {
	    try {
	        PCBinaryInputStream file = new PCBinaryInputStream(input);
	        read(file);
	    } catch (IOException e) {
	        System.err.println(e);
	    }
	...
	public void write(OutputStream out) {
	    try {
	        PCBinaryOutputStream file = new PCBinaryOutputStream(out);
	        write(file);
	    } catch (IOException e) {
	        System.err.println(e);
	    }
